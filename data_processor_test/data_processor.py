...
INPUT_HTML = r"E:\下载\donk_startDate_2025-11-28_endDate_2026-02-28_rankingFilter_Top20.html"
OUTPUT_BASE_DIR = r"E:\OneDrive - International Campus, Zhejiang University\EquiRating\data_processor_test\processed_data"

# =========================
# 自动生成选手文件夹
# =========================

player_name = os.path.splitext(os.path.basename(INPUT_HTML))[0]
